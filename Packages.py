...
# the time each truck leaves the hub
first_time = '8:00:00'
second_time = '9:10:00'
third_time = '11:00:00'

# converting the string time into a datetime.timedelta
...
# for loop takes the values in the first truck and runs them through the distance functions in the Distances.py file
# space-time complexity is O(N)
...
def total_distance():
    total_dist = first_truck_total_distance + second_truck_total_distance + third_truck_total_distance
    return total_dist